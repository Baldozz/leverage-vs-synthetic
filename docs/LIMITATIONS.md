...
15. **Long-dated implied vol is extrapolated, not observed.** Bloomberg SPX ATM implied vols stop at 24 months (from May 2005); the 5-year series is the 24-month series raised to a fitted elasticity (VIX proxy before 2005). Backing the premium out of the J.P. Morgan chart suggests dealer 5-year ATM premiums were ≈ 25 % higher than ours at the 2009 and 2013 troughs, so the call-vs-cash backtest overstates the call P&L for those vintages. The 7- and 10-year backtests run on their own Treasury columns but on vols extrapolated one step further (Assumptions 19n: elasticity curve extended to 7 and 10 years, mean level held at the 5-year one); the 7-year yield is interpolated between 5y and 10y until a `USGG7YR` / `H15T7Y` export is supplied. Dealer marks at 5/7/10 years (a historical series, or at least dated quotes) are the only way to replace the extrapolation with observed long-dated vol.
