...
| Final NAV (m) | Keep the loan | Keep's exposure (1 vol pt) | Keep's exposure (no haircut) | Keep's exposure (SPX sold below the band) | Same dollar delta | Same index units |
|---|---|---|---|---|---|---|
| lowest | 2,011 | 1,973 | 1,973 | 1,973 | 1,991 | 1,971 |
| 5th pct | 2,548 | 2,580 | 2,581 | 2,580 | 2,704 | 2,560 |
| 25th pct | 4,186 | 4,226 | 4,226 | 4,226 | 4,902 | 4,251 |
| median | 7,312 | 7,239 | 7,250 | 7,335 | 11,104 | 6,815 |
| 75th pct | 8,818 | 8,891 | 8,909 | 8,936 | 15,455 | 8,244 |
| 95th pct | 11,585 | 11,685 | 11,691 | 11,801 | 27,655 | 11,275 |
| highest | 14,240 | 14,833 | 14,837 | 14,833 | 34,942 | 14,736 |

| Annualised return | Keep the loan | Keep's exposure (1 vol pt) | Keep's exposure (no haircut) | Keep's exposure (SPX sold below the band) | Same dollar delta | Same index units |
|---|---|---|---|---|---|---|
| lowest | 8.8% | 8.5% | 8.5% | 8.6% | 10.0% | 7.7% |
| 5th pct | 9.2% | 9.1% | 9.1% | 9.1% | 10.7% | 8.2% |
| 25th pct | 11.9% | 11.8% | 11.8% | 12.0% | 14.2% | 11.5% |
| median | 15.3% | 15.4% | 15.4% | 15.4% | 17.7% | 15.5% |
| 75th pct | 16.5% | 16.8% | 16.8% | 16.8% | 19.0% | 16.8% |
| 95th pct | 18.3% | 18.6% | 18.6% | 18.6% | 20.2% | 18.5% |
| highest | 25.4% | 25.3% | 25.3% | 25.3% | 25.6% | 25.2% |
| rotation ahead on (same start) |  | 72% | 74% | 82% | 99% | 53% |
| median Δ annualised, Rotate − Keep |  | +0.1 pp | +0.1 pp | +0.1 pp | +2.4 pp | +0.1 pp |
| worst Δ final NAV (m), same start |  | -696 | -672 | -262 | -23 | -2,176 |
| best Δ final NAV (m), same start |  | +593 | +597 | +593 | +21,672 | +498 |
...
| median | 1,492 | 1,480 | 1,480 | 1,480 | 1,490 | 1,491 |
| 75th pct | 1,644 | 1,653 | 1,653 | 1,653 | 1,664 | 1,665 |
| 95th pct | 1,884 | 1,868 | 1,868 | 1,868 | 1,889 | 1,881 |
...
| 95th pct | 28.7% | 27.8% | 27.8% | 27.8% | 27.8% | 27.8% |
| highest | 42.8% | 41.9% | 41.9% | 41.9% | 41.9% | 41.9% |
| rotation ahead on (same start) |  | 30% | 30% | 30% | 40% | 40% |
| median Δ annualised, Rotate − Keep |  | -0.3 pp | -0.3 pp | -0.3 pp | -0.2 pp | -0.2 pp |
| worst Δ final NAV (m), same start |  | -42 | -42 | -41 | -36 | -42 |
| best Δ final NAV (m), same start |  | +15 | +15 | +15 | +33 | +33 |
...
| Per start (median, or total) | Keep's exposure (1 vol pt) | Keep's exposure (no haircut) | Keep's exposure (SPX sold below the band) |
|---|---|---|---|
| rolls (expiries with a decision) | 63 | 63 | 63 |
| rolls skipped (gap ≤ 0) | 0 | 0 | 0 |
| rebalances up (calls sold) | 28 | 28 | 28 |
| rebalances down (calls bought) | 0 | 0 | 0 |
| partial rebalances (T-bills short) | 0 | 0 | 0 |
| calls sold at rebalances (m) | 497 | 500 | 497 |
| calls bought at rebalances (m) | 0 | 0 | 0 |
| SPX sold at rebalances (m) | 0 | 0 | 0 |
| unwind cost (m), median start | 1.9 | 0.0 | 1.9 |
| unwind cost (m), all starts | 7,521 | 0 | 5,723 |
| cut replacements | 0 | 0 | 0 |
| exposure ÷ Keep's today: 5th / median / 95th pct | 1.02 / 1.10 / 1.10 | 1.02 / 1.10 / 1.10 | 1.02 / 1.10 / 1.10 |
