"""Strategy replay (supporting material) — "if we had run A, B and C from a given date, what would the P&L have been?"

The primary analysis is the call-vs-cash backtest in app/historical_app.py; this app is kept for reference.
...
Run:  .venv/bin/streamlit run app/strategy_replay_app.py
"""
